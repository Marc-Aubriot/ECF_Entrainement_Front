...
const Prestations = () => {
    ...
    const cards = [
        ...
        ["Famille", pic_famille, "220€", "Pour la famille ou les amis jusqu'à 4 personnes, en extérieur ou en studio. 30 euros en supllément par personne au-delà de 4 (hormis enfant jusqu'à 2ans).","#6C60A8"],
